...
const SUB_PATH = process.env.SUB_PATH || 'solo';       // 订阅路径
const PORT = process.env.SERVER_PORT || process.env.PORT || 3000;        // http服务订阅端口
const UUID = process.env.UUID || '26a1f636-5a82-4b31-8836-28eafc08d0a7'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
...
const NAME = process.env.NAME || 'solo';                        // 节点名称
